...
class App
{
    ...
    {
        /**
         * @Ling 为了本地调试方便,只有生产环境才会加载生成的缓存文件
         */
        ...
        // 加载初始化文件
        if (is_file(APP_PATH . $module . 'init' . EXT) && APP_ENV_IS_PRODUCTION) {
            include APP_PATH . $module . 'init' . EXT;
        } elseif (is_file(RUNTIME_PATH . $module . 'init' . EXT) && APP_ENV_IS_PRODUCTION) {
    ...
    public static function routeCheck($request, array $config)
    {
        ...
        if ($check) {
            // 开启路由
            /* @Ling 为了本地调试方便,只有生产环境才会加载生成的缓存文件 */
            if (is_file(RUNTIME_PATH . 'route.php') && APP_ENV_IS_PRODUCTION) {
                // 读取路由缓存
